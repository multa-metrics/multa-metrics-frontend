...
import "../../css/stylesPhoneInputSign.css";
const schema = {
  firstName: {
  ...
  password: {
    ...
    format: {
      ...
      message:
        "must contain at least one numeric digit, one uppercase and one lowercase letters",
    },
  },
  confirmPassword: {
    presence: { allowEmpty: false, message: "is required" },
  ...
  const confirmSingUp = async (event) => {
    ...
    try {
      await Auth.confirmSignUp(email, code, {
        clientMetadata: { organization_name: organization },
      });
                  ...
                  <TextField
                    ...
                    helperText={
                      hasError("organization")
                        ? formState.errors.organization[0]
                        : null
                    }
                    label="Organization"
                    name="organization"
